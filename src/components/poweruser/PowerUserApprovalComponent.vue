...
export default {
    ...
    methods:{
        ...
        this.editedIndex = this.requestedrecords.indexOf(item)
        this.editedItem = Object.assign({}, item)
        console.log("APPROVING ITEM...") //console.log(this.editedItem)
        ...
        async display(){
            ...
            z.forEach( docs => {
                ...
                //IN DEVELOPMENT: var making = await this.percentage_Makeout(showItemName, showItemId, showOrderQuantity)
                //IN DEVELOPMENT: var showNotes = making.toString() + " %"
                //RAN INTO [Object promise] ERROR NEED Resolution
        ...
        async checkQuantity (showItemId, showItemName, showOrderQuantity){
            //console.log("here check quantity") console.log(showItemName + " " + showItemId)
        ...
        async checkAutoOrderMechanism (showItemId, showItemName){
            //console.log("INITIALISE AUTOMECHANISM ALGORITHM") console.log(showItemName + " " + showItemId)
            ...
            try {
                ...
                if ( gotPendingArrival == true) {
                    if (overallQty <= lowerthresholdqty){
                        //console.log("There is Pending Arrivals. Just top up balance!");
            ...
            try{
                ...
                if (quantityStatus[0] == "Okay" || quantityStatus[0] == "Low Stock"){
                    ...
                    if (quantityStatus[0] == "Low Stock"){
                        ...
                        //RESTOCKING//
                        //Check for current supplies + pending arrival if exceed threshold2 if not, order else don't order
                    ...
                    if(quantityStatus[0] == "Not Okay" && this.decision == 'No Decision' ) {
                        ...
                        //FUTURE DEVELOPMENT (IN CONSTRUCTION)
