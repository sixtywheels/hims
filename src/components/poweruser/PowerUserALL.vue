        ...
        <template v-slot:item.Order_Quantity = "props">
            <div>
                ...
                :max = "props.item.Threshold2" show-value>
                    <b-progress-bar variant="danger" :value = "props.item.Order_Quantity"></b-progress-bar>
    ...
    methods: {
        async display(){
            ...
            z.forEach((docs) => {
                ...
                var threshold1 = yy.Threshold1

                if (quant < threshold1) {
                    x.Item_Name = name
                    x.Order_Quantity = quant
                    x.Item_Id = yy.Item_Id
                    x.Threshold1 = threshold1
        ...
        async save (props) {
            ...
            if (g > d) {
                ...
                if (Topupper < 0) {
                    ...
                    await setDoc(doc(db, "PendingArrival", Trans_Id.toString()), {Item_Id: parseInt(a), Item_Name: c, Category: e, Topup_Quantity: Topupper, Trans_id: Trans_Id, Timestamp: dateTime})
